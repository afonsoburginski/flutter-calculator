                    ...
                    Align(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            ...
                            color: darkMode ? Colors.white : Color(0xff42a5f5)),
                      ),
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                              fontSize: 35,
                              color:
                                  darkMode ? Color(0xFF6d57ff) : Colors.grey),
                        ),
                        Text(
                          '10+500*12',
                          style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      _buttonRounded(
                          title: 'C',
                          textColor:
                              darkMode ? Color(0xFF6d57ff) : Color(0xff42a5f5)),
    ...
    return NeuContainer(
      ...
      child: Container(
        ...
        child:
          ...
          Icon(
            Icons.wb_sunny,
            color: darkMode ? Colors.grey : Color(0xff42a5f5),
          ),
          Icon(
            Icons.nightlight_round,
            color: darkMode ? Color(0xff6d57ff) : Colors.grey,
          ),
        ]),
      ),
    );
